    ...
    <div class="container">
        ...
        <div class="single-cinematography-section mt-5 pt-5 mb-5 pb-5">
            ...
            <div class="c-snapshots mt-md-5">
                    ...
                    <img class="c-snapshot-img" src="<?php echo get_template_directory_uri() . '/assets/img/Cinematography/GEN_Z_UNRAVELLED/GEN_Z_4.webp' ?>" alt="">
                    <img class="c-snapshot-img" src="<?php echo get_template_directory_uri() . '/assets/img/Cinematography/GEN_Z_UNRAVELLED/GEN_Z_5.webp' ?>" alt="">
                    <img class="c-snapshot-img" src="<?php echo get_template_directory_uri() . '/assets/img/Cinematography/GEN_Z_UNRAVELLED/GEN_Z_6.webp' ?>" alt="">
            </div>
            <div class="c-final-text">
                <p>CURRENTLY IN A FESTIVAL RUN, COMING SOON</p>
            </div>
